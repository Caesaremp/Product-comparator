...
const SPEC_COLUMN_DEFINITIONS = {
  ...
  Frullatore: [
    { key: "brand", column: "blender_brand", kind: "text" },
    { key: "model", column: "blender_model", kind: "text" },
    { key: "power", column: "blender_power_w", kind: "number" },
    { key: "rpm", column: "blender_rpm", kind: "number" },
    { key: "capacity", column: "blender_capacity_l", kind: "number" },
    { key: "usableCapacity", column: "blender_usable_capacity_l", kind: "number" },
    { key: "travelCupCapacity", column: "blender_travel_cup_capacity_l", kind: "number" },
    { key: "programs", column: "blender_programs", kind: "text" },
    { key: "manualSpeeds", column: "blender_manual_speeds", kind: "text" },
    { key: "bladeTechnology", column: "blender_blade_technology", kind: "text" },
    { key: "bladeMaterial", column: "blender_blade_material", kind: "text" },
    { key: "bladeCount", column: "blender_blade_count", kind: "number" },
    { key: "jarMaterial", column: "blender_jar_material", kind: "text" },
    { key: "dishwasherSafe", column: "blender_dishwasher_safe", kind: "text" },
    { key: "bpaFree", column: "blender_bpa_free", kind: "text" },
    { key: "iceCrush", column: "blender_ice_crush", kind: "text" },
    { key: "weight", column: "blender_weight_kg", kind: "number" },
    { key: "dimensions", column: "blender_dimensions", kind: "text" },
    { key: "includedAccessories", column: "blender_included_accessories", kind: "text" },
  ],
  Generico: [
...
db.exec(`
  CREATE TABLE IF NOT EXISTS products (
    ...
    blender_brand TEXT,
    blender_model TEXT,
    blender_power_w REAL,
    blender_rpm REAL,
    blender_capacity_l REAL,
    blender_usable_capacity_l REAL,
    blender_travel_cup_capacity_l REAL,
    blender_programs TEXT,
    blender_manual_speeds TEXT,
    blender_blade_technology TEXT,
    blender_blade_material TEXT,
    blender_blade_count REAL,
    blender_jar_material TEXT,
    blender_dishwasher_safe TEXT,
    blender_bpa_free TEXT,
    blender_ice_crush TEXT,
    blender_weight_kg REAL,
    blender_dimensions TEXT,
    blender_included_accessories TEXT,
    generic_brand TEXT,
    generic_model TEXT,
...
const migrateColumns = [
  ...
  { name: "blender_brand", type: "TEXT" },
  { name: "blender_model", type: "TEXT" },
  { name: "blender_power_w", type: "REAL" },
  { name: "blender_rpm", type: "REAL" },
  { name: "blender_capacity_l", type: "REAL" },
  { name: "blender_usable_capacity_l", type: "REAL" },
  { name: "blender_travel_cup_capacity_l", type: "REAL" },
  { name: "blender_programs", type: "TEXT" },
  { name: "blender_manual_speeds", type: "TEXT" },
  { name: "blender_blade_technology", type: "TEXT" },
  { name: "blender_blade_material", type: "TEXT" },
  { name: "blender_blade_count", type: "REAL" },
  { name: "blender_jar_material", type: "TEXT" },
  { name: "blender_dishwasher_safe", type: "TEXT" },
  { name: "blender_bpa_free", type: "TEXT" },
  { name: "blender_ice_crush", type: "TEXT" },
  { name: "blender_weight_kg", type: "REAL" },
  { name: "blender_dimensions", type: "TEXT" },
  { name: "blender_included_accessories", type: "TEXT" },
];
